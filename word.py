...
次日，众猴果去采仙桃，摘异果，刨山药，斸黄精。芝兰香蕙，瑶草奇花，般般件件，整整齐齐，摆开石凳石桌，排列仙酒仙殽。但见那：
...
有分有缘休俗愿，无忧无虑会元龙。
料应必遇知音者，说破源流万法通。
也是他运至时来，自登木筏之后，连日东南风紧，将他送到西北岸前，乃是南赡部洲地界。持篙试水，偶得浅水，弃了筏子，跳上岸来。只见海边有人捕鱼、打雁、穵蛤、淘盐。他走近前，弄个把戏，妆个𡤫虎，吓得那些人丢筐弃网，四散奔跑。将那跑不动的拿住一个，剥了他衣裳，也学人穿在身上。摇摇摆摆，穿州过府，在市廛中学人礼，学人话。朝餐夜宿，一心里访问佛、仙、神圣之道，觅个长生不老之方。见世人都是为名为利之徒，更无一个为身命者。正是那：

争名夺利几时休？早起迟眠不自由！
骑著驴骡思骏马，官居宰相望王侯。
只愁衣食耽劳碌，何怕阎君就取勾。
继子荫孙图富贵，更无一个肯回头。
猴王参访仙道，无缘得遇。在于南赡部洲，串长城，游小县，不觉八九年馀。忽行至西洋大海，他想著海外必有神仙。独自个依前作筏，又飘过西海，直至西牛贺洲地界。登岸遍访多时，忽见一座高山秀丽，林麓幽深。他也不怕狼虫，不惧虎豹，登上山顶上观看。果是好山：
...
头上戴箬笠，乃是新笋初脱之箨。身上穿布衣，乃是木绵撚就之纱。腰间系环绦，乃是老蚕口吐之丝。足下踏草履，乃是枯莎槎就之爽。手执衠钢斧，担挽火麻绳。扳松劈枯树，争似此樵能。
...
adjectives = [word.word for word in words if word.flag == 'a' and len(word.word) >= 2]
counter = Counter(adjectives)

most_common = counter.most_common(10)
adjectives, frequencies = zip(*most_common)

bar = Bar()
bar.add_xaxis(list(adjectives))
bar.add_yaxis("频率", list(frequencies))
bar.set_global_opts(title_opts=opts.TitleOpts(title="西游记第一回形容词词频分析"))
bar.render("adjectives_frequency.html")
